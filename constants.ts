...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  ...
  DE: {
    ...
    Europe: "Europa", Asia: "Asien", Oceania: "Ohzeanien", Africa: "Afrika", Americas: "Amerika"
  },
  JP: {
...
export const MOCK_DEALS: Deal[] = [
  ...
  },
  {
    ...
    location: "Italy",
    city: "Positano",
    description: "Escape the crowds of Positano. A private boat tour taking you to secluded inlets and hidden pebble beaches accessible only from the sea.",
