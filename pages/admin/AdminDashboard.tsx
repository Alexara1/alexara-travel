...
const AdminDashboard: React.FC = () => {
  ...
  const handleExportSyncData = () => {
    ...
    alert("Database snapshot copied to clipboard as JSON. You can paste this in another browser's sync importer (feature coming soon) or keep it as a backup.");
  };

  const handleGenerateProductionCode = () => {
    const fileContent = `
...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = ${JSON.stringify(TRANSLATIONS, null, 2)};
...
`;
    ...
    alert("Production code for 'constants.ts' generated and copied to clipboard. Follow step 2 and 3 of the instructions to update your site globally.");
  };
      ...
      <main className="flex-1 p-8 overflow-y-auto h-screen">
                     ...
                     <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                         ...
                         <div className="flex flex-col justify-center h-64 space-y-6">
                             ...
                             <div className="space-y-2">
                                ...
                                <div className="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden">
                                    <div className="bg-indigo-50 h-full transition-all duration-1000" style={{ width: `${analyticsData.devices.desktop}%` }}></div>
                                </div>
                             </div>
        ...
        {activeTab === 'sync' && (
            <div className="animate-in fade-in duration-500">
                <div className="bg-slate-900 rounded-[3rem] p-12 text-white shadow-3xl border border-white/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center space-x-4 mb-8">
                            ...
                            <h1 className="text-4xl font-serif font-bold">Global Persistence Core</h1>
                        </div>
                        
                        <p className="text-blue-100/70 max-w-2xl mb-12 leading-relaxed text-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 text-center flex flex-col items-center group hover:bg-white/10 transition-all duration-300">
                                <Database className="w-12 h-12 text-secondary mb-6 group-hover:scale-110 transition-transform" />
                                <h3 className="text-2xl font-bold mb-4">Browser Sync</h3>
                                <p className="text-blue-100/50 text-sm mb-10 flex-1">Transfer your changes to another browser or computer instantly.</p>
                                <button 
                                    onClick={handleExportSyncData}
                                    className="bg-secondary hover:bg-teal-500 text-white font-black py-4 px-10 rounded-2xl transition-all shadow-xl uppercase tracking-widest text-xs"
                                >
                                    EXPORT SYNC DATA
                                </button>
                            </div>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 text-center flex flex-col items-center group hover:bg-white/10 transition-all duration-300">
                                <Code className="w-12 h-12 text-secondary mb-6 group-hover:scale-110 transition-transform" />
                                <h3 className="text-2xl font-bold mb-4">Deploy Globally</h3>
                                <p className="text-blue-100/50 text-sm mb-10 flex-1">Generate the source code required to update the site permanently via GitHub.</p>
                                <button 
                                    onClick={handleGenerateProductionCode}
                                    className="bg-white hover:bg-gray-100 text-slate-900 font-black py-4 px-10 rounded-2xl transition-all shadow-xl uppercase tracking-widest text-xs"
                                >
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                            <h4 className="text-xs font-black uppercase tracking-[0.3em] text-secondary mb-6 flex items-center">
                                <Info className="w-4 h-4 mr-2" /> Deployment Instructions
                            </h4>
                            <div className="space-y-4 text-sm text-blue-100/60">
                                <div className="flex items-start">
                                    <span className="w-6 h-6 rounded-full bg-secondary/20 text-secondary flex items-center justify-center font-bold text-xs mr-4 shrink-0">1</span>
                                    <p><span className="text-white font-bold">Generate Code:</span> Click the button above to copy your current database state to your clipboard.</p>
                                </div>
                                <div className="flex items-start">
                                    <span className="w-6 h-6 rounded-full bg-secondary/20 text-secondary flex items-center justify-center font-bold text-xs mr-4 shrink-0">2</span>
                                    <p><span className="text-white font-bold">Update Source:</span> Open your project's <code className="bg-white/10 px-1.5 py-0.5 rounded text-secondary">constants.ts</code> file in your code editor (or on GitHub).</p>
                                </div>
                                <div className="flex items-start">
                                    <span className="w-6 h-6 rounded-full bg-secondary/20 text-secondary flex items-center justify-center font-bold text-xs mr-4 shrink-0">3</span>
                                    <p><span className="text-white font-bold">Deploy:</span> Delete everything in that file, paste the new code, and Push/Commit the changes.</p>
                                </div>
                                <p className="mt-6 pt-6 border-t border-white/5 text-[11px] italic">Once Vercel finishes the build, your updates will be "baked into" the website and will appear for every visitor on every browser globally.</p>
                            </div>
                        </div>
                    </div>
                </div>
